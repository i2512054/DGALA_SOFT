                        ...
                        <form action="">
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select id="document_type_id" name="document_type_id" class="default-select form-control wide" required>
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-4">
                                    ...
                                    <select id="department_code" name="department_code" onchange="loadProvince();" required>
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <select id="province_code" name="province_code" onchange="loadDistrict();" required>
                                        <option selected="">Seleccione Provincia ...</option>
                                    </select>
                                </div>
                                <div class="mb-3 col-md-4">
                                    <label class="form-label">Distrito</label>
                                    <select id="district_code" name="district_code" onchange="onSelUbigeo();" required>
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input id="access" name="access" type="password" class="form-control" required />
                                </div>
                                <div class="mb-3 col-md-4">
                                    <label class="form-label">Repetir Contraseña</label>
                                    <input id="access_repeat" name="access_repeat" type="password" class="form-control" required />
                                </div>
                                <div class="mb-3 col-md-4">
                                    <br />
