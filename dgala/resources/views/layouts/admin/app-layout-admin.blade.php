							...
							<li class="nav-item dropdown  header-profile">
								...
								<div class="dropdown-menu dropdown-menu-end" style="background-color: black;">
                                    ...
                                    <form action="/admin/logout" method="POST">
                                        @csrf
                                        <button type="submit" style="border: 0; text-align:left;" class="w-100">
            ...
            <div class="dlabnav" style="background-color: black;">
                <div class="dlabnav-scroll">
                    <ul class="metismenu" id="menu">
                        <li><a href="/admin/dashboard" class="" aria-expanded="false"><i class="fas fa-grip-horizontal"></i><span class="nav-text">Dashboard</span></a></li>
                        <li><a href="/admin/categories" class="" aria-expanded="false"><i class="fas fa-list"></i><span class="nav-text">Categorías</span></a></li>
                        <li><a href="/admin/products" class="" aria-expanded="false"><i class="fas fa-building"></i><span class="nav-text">Productos</span></a></li>
                        <li><a href="/admin/customers" class="" aria-expanded="false"><i class="fas fa-users"></i><span class="nav-text">Clientes</span></a></li>
                        <li><a href="/admin/sales" class="" aria-expanded="false"><i class="fas fa-file-invoice-dollar"></i><span class="nav-text">Ventas</span></a></li>
                        <li><a href="/admin/reports" class="" aria-expanded="false"><i class="fas fa-chart-line"></i><span class="nav-text">Reportes</span></a></li>
